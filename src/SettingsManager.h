...
#define ENABLED_VALUES_NUM_TAG "ENABLED-VALUES-NUM"
#define ENABLED_BINVALUES_NUM_TAG "ENABLED-BINVALUES-NUM"
#define VALUE_TYPE_N_TAG "VALUE-TYPE-"
#define BIN_VALUE_TYPE_N_TAG "BINVALUE-TYPE-"
